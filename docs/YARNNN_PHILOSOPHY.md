# YARNNN Service Philosophy - Canon v1.3.1

**The Authoritative Philosophy of Yarnnn as a Memory-First Cognitive System**
...
- **YARNNN_CANON.md** - Executive summary and version control
- **YARNNN_MEMORY_MODEL.md** - Substrate lifecycle and relationships
- **YARNNN_SUBSTRATE_RUNTIME.md** - Pipeline boundaries and RPCs
- **YARNNN_INGESTION_CANON.md** - Sacred write paths
- **YARNNN_AUTH_WORKFLOW.md** - Security model
- **YARNNN_BASKETS_WORK_CANON.md** - UI/UX patterns

---

*This philosophy document synthesizes the canonical Yarnnn documentation into a cohesive vision. All implementation must conform to these principles.*