...
--
-- Name: objects allow_all_basket-dumps oo916g_0; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "allow_all_basket-dumps oo916g_0" ON storage.objects FOR SELECT TO authenticated, service_role USING ((bucket_id = 'basket-dumps'::text));


--
-- Name: objects allow_all_basket-dumps oo916g_1; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "allow_all_basket-dumps oo916g_1" ON storage.objects FOR INSERT TO authenticated, service_role WITH CHECK ((bucket_id = 'basket-dumps'::text));


--
-- Name: objects allow_all_block-files 1vgcyev_0; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "allow_all_block-files 1vgcyev_0" ON storage.objects FOR SELECT TO authenticated, service_role USING ((bucket_id = 'block-files'::text));


--
-- Name: objects allow_all_block-files 1vgcyev_1; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "allow_all_block-files 1vgcyev_1" ON storage.objects FOR INSERT TO authenticated, service_role WITH CHECK ((bucket_id = 'block-files'::text));


--
-- Name: objects allow_authenticated_select,insert,update,delete 7gbu0p_0; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "allow_authenticated_select,insert,update,delete 7gbu0p_0" ON storage.objects FOR SELECT TO authenticated, service_role USING ((bucket_id = 'user-library'::text));


--
-- Name: objects allow_authenticated_select,insert,update,delete 7gbu0p_1; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "allow_authenticated_select,insert,update,delete 7gbu0p_1" ON storage.objects FOR INSERT TO authenticated, service_role WITH CHECK ((bucket_id = 'user-library'::text));
