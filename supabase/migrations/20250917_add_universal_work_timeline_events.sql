-- Add universal work orchestration timeline events to allowed kinds
-- Fixes: work.initiated violates timeline_events_kind_check constraint
-- Canon v2.1: Universal Work Orchestration timeline events
...
-- Add new constraint with universal work events included
