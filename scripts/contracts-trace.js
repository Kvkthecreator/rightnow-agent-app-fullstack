...
// Regex patterns for parsing annotations (account for JSDoc * prefix)
const routePattern = /^\s*\*?\s*Route:\s*(\w+)\s+(.+)$/m;
const componentPattern = /^\s*\*?\s*Component:\s*(.+)$/m;
const pagePattern = /^\s*\*?\s*Page:\s*(.+)$/m;
const contractInputPattern = /^\s*\*?\s*@contract\s+input\s*:\s*(.+)$/m;
const contractOutputPattern = /^\s*\*?\s*@contract\s+output\s*:\s*(.+)$/m;
const contractRendersPattern = /^\s*\*?\s*@contract\s+renders\s*:\s*(.+)$/m;
