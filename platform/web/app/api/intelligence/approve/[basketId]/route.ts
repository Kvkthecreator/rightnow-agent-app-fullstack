...
// All intelligence approvals now go through /api/work (universal governance)
...
export async function GET() {
  return NextResponse.json(
    { error: "Endpoint migrated to Universal Work. Use /api/work with work_type 'PROPOSAL_REVIEW' or appropriate type." },
    { status: 410 }
  );
}
