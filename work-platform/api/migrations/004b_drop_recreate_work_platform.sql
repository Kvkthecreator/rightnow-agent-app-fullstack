-- Drop and recreate work platform tables with Phase 1 simplified schema
-- Created: 2025-11-06
-- Purpose: Replace Phase 6 complex schema with streamlined Phase 1 design

-- ============================================================================
-- DROP EXISTING TABLES (from Phase 6)
-- ============================================================================
...
-- ============================================================================
-- Projects Table (Phase 1: Simplified)
-- ============================================================================
...
-- ============================================================================
-- Work Sessions Table (Phase 1: Simplified)
-- ============================================================================
...
-- ============================================================================
-- Work Artifacts Table (Phase 1: Simplified)
-- ============================================================================
...
-- ============================================================================
-- Work Checkpoints Table (Phase 1: Simplified)
-- ============================================================================
...
CREATE INDEX idx_projects_basket ON projects(basket_id);
...
CREATE INDEX idx_work_sessions_basket ON work_sessions(basket_id);
CREATE INDEX idx_work_sessions_workspace ON work_sessions(workspace_id);
CREATE INDEX idx_work_sessions_user ON work_sessions(initiated_by_user_id);
CREATE INDEX idx_work_sessions_status ON work_sessions(status);
CREATE INDEX idx_work_sessions_task_type ON work_sessions(task_type);

-- Work artifacts indexes
CREATE INDEX idx_work_artifacts_session ON work_artifacts(work_session_id);
CREATE INDEX idx_work_artifacts_status ON work_artifacts(status);
CREATE INDEX idx_work_artifacts_type ON work_artifacts(artifact_type);

-- Work checkpoints indexes
CREATE INDEX idx_work_checkpoints_session ON work_checkpoints(work_session_id);
CREATE INDEX idx_work_checkpoints_status ON work_checkpoints(status);
...
COMMENT ON TABLE projects IS 'Work domain containers linking 1:1 with context baskets (Phase 1)';
COMMENT ON TABLE work_sessions IS 'Individual work requests with agent execution tracking (Phase 1)';
COMMENT ON TABLE work_artifacts IS 'Agent-produced outputs during work session execution (Phase 1)';
COMMENT ON TABLE work_checkpoints IS 'Pause points for user review during agent execution (Phase 1)';
