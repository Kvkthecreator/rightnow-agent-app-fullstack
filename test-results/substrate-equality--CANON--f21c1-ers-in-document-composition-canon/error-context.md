...
- Name: [CANON] Substrate Equality >> all substrate types are treated as peers in document composition
- Location: /Users/macbook/rightnow-agent-app-fullstack/tests/canon/substrate-equality.spec.ts:18:7
...
Call log:
  - waiting for locator('button:has-text("Add Reference")')
    ...
    at /Users/macbook/rightnow-agent-app-fullstack/tests/canon/substrate-equality.spec.ts:20:16
```
