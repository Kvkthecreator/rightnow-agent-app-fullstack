...
>  49 |     expect(queueResponse.ok()).toBeTruthy();
  ...
  143 |     
  144 |     // Verify all canonical pipeline agents are present
  145 |     expect(agents.P0_CAPTURE).toBeDefined();
  146 |     expect(agents.P1_SUBSTRATE).toBeDefined(); 
  147 |     expect(agents.P2_GRAPH).toBeDefined();
  148 |     expect(agents.P3_REFLECTION).toBeDefined();
  149 |     
```