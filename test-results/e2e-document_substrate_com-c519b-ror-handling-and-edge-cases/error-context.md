...
- Name: Document Substrate Composition E2E >> error handling and edge cases
- Location: /Users/macbook/rightnow-agent-app-fullstack/tests/e2e/document_substrate_composition.spec.ts:118:7
...
Call log:
  - waiting for locator('button:has-text("Add Reference")')
    ...
    at /Users/macbook/rightnow-agent-app-fullstack/tests/e2e/document_substrate_composition.spec.ts:122:16
```
